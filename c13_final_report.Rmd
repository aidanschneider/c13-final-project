...
In the following code block we import the data from our data file as dataframes for ease of use in data analysis. 
...
As stated, we use the following metrics to quantify "quality of life":
...
Given that a majority of communist states fragmented into multiple smaller, democratic nations between 1980 and 2005, we decided to only analyze this timeframe. We also noticed from our EDA that there were inflection points in some of the metrics we would use to quantify quality of life. This is demonstrated in the following graphs, which are isolated to this 1980-2005 timeframe.
